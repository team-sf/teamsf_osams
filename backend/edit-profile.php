...
<body class="hold-transition sidebar-mini" onload="refresh()">
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="edit-profile.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="card shadow-sm mt-4" style="height: 560px;">
        	...
        	<div class="card-body">
        		<div class="container">
                  ...
                  <div class="form-row mb-4">
                    <div class="col-lg-4">
                      <label>Town Contact Number</label>
