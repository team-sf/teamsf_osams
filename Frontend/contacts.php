...
<!-- Mirrored from themes.rokaux.com/unishop/v3.0/template-1/contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Nov 2018 05:44:12 GMT -->
<head>
    <meta charset="utf-8">
    <title>Contacts
    </title>
    ...
    <div class="offcanvas-wrapper">
      ...
      <div class="container padding-bottom-2x mb-2">
        <div class="row">
          ...
          <div class="col-md-5">
            <ul class="list-icon">
              <li> <i class="icon-mail"></i>customer.service@otop.com</a></li>
              <li> <i class="icon-bell"></i>+63 967 691 0415</li>
        ...
        <div class="row margin-top-2x">
          ...
          <div class="col-md-5">
            <ul class="list-icon">
              <li> <i class="icon-mail"></i><a class="navi-link" href="mailto:support@unishop.com">support@otop.com</a></li>
