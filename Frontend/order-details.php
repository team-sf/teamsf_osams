  ...
  <body>
    ...
    <div class="offcanvas-wrapper">
      ...
      <div class="page-title">
        <div class="container">
          <div class="column">
            <h1>Transaction Code: <strong><?php print $transcode?></strong></h1>
          </div>
          <div class="column">
          ...
          <div class="col-xl-9 col-lg-8">
            <div class="table-responsive shopping-cart">
              <table class="table">
                ...
                <tbody>
                    <?php
                        $sqlStatement = "SELECT * FROM cart_tbl JOIN product_tbl ON product_tbl.id = cart_prod_id WHERE cart_code = '$transcode'";
          ...
          <div class="col-xl-3 col-lg-4">
            <aside class="sidebar">
              ...
              <section class="widget widget-order-summary">
                ...
                <table class="table">
                    <?php
                    $sqlStatement = "SELECT SUM(cart_total) AS 'Total', SUM(cart_total) * .12 AS 'Tax', SUM(cart_total) - SUM(cart_total) * .12 AS 'Subtotal' FROM cart_tbl JOIN customer_tbl ON cust_id = cart_cust_id JOIN product_tbl ON product_tbl.id = cart_prod_id WHERE cart_code = '$transcode'";
                    if($osams->select($sqlStatement) != 0) {
                        foreach ($osams->select($sqlStatement) as $value) {
                            ?>
                            <tr>
